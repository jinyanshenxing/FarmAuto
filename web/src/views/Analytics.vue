...
<template>
  <div class="p-4">
    ...
    <div v-else-if="list.length === 0" class="card-panel p-8 text-center text-gray-500">
      暂无数据
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      <div class="block sm:hidden space-y-4">
        <div v-for="(item, idx) in list" :key="idx" class="card-panel p-4">
      ...
      <!-- Desktop Table View -->
      <div class="card-panel hidden overflow-hidden sm:block">
